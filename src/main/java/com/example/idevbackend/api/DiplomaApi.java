...
public class DiplomaApi {
    ...
    @Operation(summary = "Создание диплома", description = "Создает новый диплом для указанного курса")
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN')")
    @Operation(summary = "Обновление диплома", description = "Обновляет диплом по его ID")
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN')")
    @Operation(summary = "Удаление диплома", description = "Удаляет диплом по его ID")
    public MessageResponse deleteDiploma(@PathVariable Long id) {
        return diplomaService.delete(id);
    }

    @GetMapping("/{id}")
    @Operation(summary = "Поиск диплома по ID", description = "Возвращает диплом по его ID")
    public DiplomaResponse findDiplomaById(@PathVariable Long id) {
        return diplomaService.findById(id);
    }

    @GetMapping("/course/{courseId}")
    @Operation(summary = "Поиск всех дипломов по ID курса", description = "Возвращает все дипломы для указанного курса")
