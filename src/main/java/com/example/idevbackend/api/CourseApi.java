...
public class CourseApi {
    ...
    @Operation(summary = "Создание нового курса",
            description = "Добавление нового курса в систему с указанием названия, описания и языка")
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN')")
    @Operation(summary = "Обновление существующего курса",
            description = "Обновление информации о курсе по идентификатору")
    ...
    @Operation(summary = "Удаление курса",
            description = "Удаление курса по идентификатору")
    ...
    @Operation(summary = "Получение курса по ID",
            description = "Получение информации о курсе по его идентификатору")
    public CourseResponse findById(@PathVariable Long id) {
        return courseService.findById(id);
    }

    @GetMapping("find/all")
    @Operation(summary = "Получение всех курсов по языку",
            description = "Получение списка всех курсов, фильтрованных по языку")
